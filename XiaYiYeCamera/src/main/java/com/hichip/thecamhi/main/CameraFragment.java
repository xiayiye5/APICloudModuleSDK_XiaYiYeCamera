        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (holder != null) {
                if (camera.snapshot == null) {
                    ...
                    //                    Bitmap bitmap = BitmapUtils.setRoundedCorner(camera.snapshot, HiTools.dip2px(getActivity(), 5));
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (channel.getImportance() == NotificationManager.IMPORTANCE_NONE) {
                    ...
                    Notification notification = new NotificationCompat.Builder(getContext(), "camera_notification").setSmallIcon(R.drawable.ic_launcher).setTicker(camera.getNikeName()).setContentTitle(camera.getUid()).setContentText(type).setContentIntent(pendingIntent).build();
