...
public class SystemSettingActivity extends HiActivity implements ICameraIOSessionCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HiTools.cameraWhetherNull(SystemSettingActivity.this, mCamera);
		initView();
	}
	...
	private static String downloadUrl = "http://hipcam.org/goke_update.html";// 地址更改为域名地址 by time 20190906 v5.1.80 donint
	...
	private void showDialogNew() {
		...
		new AlertDialog.Builder(SystemSettingActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(getText(R.string.tips_warning)).setMessage(getText(R.string.tip_system_update_new)).setPositiveButton(getText(R.string.btn_ok), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
	...
	private void showDialogOld() {
		dismissProgressDialog();
		new AlertDialog.Builder(SystemSettingActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(getText(R.string.tips_warning)).setMessage(getText(R.string.tip_system_update_old)).setPositiveButton(getText(R.string.btn_ok), new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				...
				new AlertDialog.Builder(SystemSettingActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(getText(R.string.tips_warning)).setMessage(getText(R.string.tip_system_update)).setPositiveButton(getText(R.string.btn_ok), new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
