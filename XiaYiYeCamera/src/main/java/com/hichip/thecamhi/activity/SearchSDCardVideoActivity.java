...
public class SearchSDCardVideoActivity extends HiActivity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (id == R.id.sd_card_hour_ll) {
			...
			finish();
		} else if (id == R.id.sd_card_half_day_ll) {
			Bundle bundle = new Bundle();
			...
			SearchSDCardVideoActivity.this.setResult(RESULT_OK, intent);
			finish();
		} else if (id == R.id.sd_card_a_day_ll) {
			Bundle bundle = new Bundle();
			...
			SearchSDCardVideoActivity.this.setResult(RESULT_OK, intent);
			finish();
		} else if (id == R.id.sd_card_week_ll) {
			Bundle bundle = new Bundle();
			...
			SearchSDCardVideoActivity.this.setResult(RESULT_OK, intent);
			finish();
		} else if (id == R.id.sd_card_self_ll) {// showSearchEventPopView();
			Intent intent = new Intent(SearchSDCardVideoActivity.this, ConstomSearchActivity.class);
	...
	private void showSearchEventPopView() {
		View customView = getLayoutInflater().inflate(R.layout.popview_search_event, null, false);
		...
		/*
		 * ArrayAdapter<CharSequence> adapter = ArrayAdapter .createFromResource(SearchSDCardVideoActivity.this, R.array.event_type, android.R.layout.simple_spinner_item); adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
		 */

		/*
		 * spinEventType.setAdapter(adapter); spinEventType.setOnItemSelectedListener(new OnItemSelectedListener() {
		 * 
		...
		final DatePickerDialog.OnDateSetListener startDateOnDateSetListener = new DatePickerDialog.OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
				...
				SearchSDCardVideoActivity.this.mStartSearchCalendar.set(year, monthOfYear, dayOfMonth, SearchSDCardVideoActivity.this.mStartSearchCalendar.get(Calendar.HOUR_OF_DAY), SearchSDCardVideoActivity.this.mStartSearchCalendar.get(Calendar.MINUTE), 0);
		...
		final DatePickerDialog.OnDateSetListener stopDateOnDateSetListener = new DatePickerDialog.OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
				...
				tmp.set(year, monthOfYear, dayOfMonth, SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.HOUR_OF_DAY), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.MINUTE), 0);
				...
				if (tmp.after(SearchSDCardVideoActivity.this.mStartSearchCalendar) || tmp.equals(SearchSDCardVideoActivity.this.mStartSearchCalendar)) {
					...
					SearchSDCardVideoActivity.this.mStopSearchCalendar.set(year, monthOfYear, dayOfMonth, SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.HOUR_OF_DAY), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.MINUTE), 0);
		...
		final TimePickerDialog.OnTimeSetListener startTimeOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
			...
			public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
				...
				SearchSDCardVideoActivity.this.mStartSearchCalendar.set(SearchSDCardVideoActivity.this.mStartSearchCalendar.get(Calendar.YEAR), SearchSDCardVideoActivity.this.mStartSearchCalendar.get(Calendar.MONTH), SearchSDCardVideoActivity.this.mStartSearchCalendar.get(Calendar.DAY_OF_MONTH), hourOfDay, minute);
		...
		final TimePickerDialog.OnTimeSetListener stopTimeOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
			...
			public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
				...
				//
				Calendar tmp = Calendar.getInstance();
				tmp.set(SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.YEAR), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.MONTH), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.DAY_OF_MONTH), hourOfDay, minute, 0);

				if (tmp.after(SearchSDCardVideoActivity.this.mStartSearchCalendar) || tmp.equals(SearchSDCardVideoActivity.this.mStartSearchCalendar)) {

					SearchSDCardVideoActivity.this.mStopSearchCalendar.set(SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.YEAR), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.MONTH), SearchSDCardVideoActivity.this.mStopSearchCalendar.get(Calendar.DAY_OF_MONTH), hourOfDay, minute);
		...
		btnStartDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(SearchSDCardVideoActivity.this, startDateOnDateSetListener, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DAY_OF_MONTH)).show();
			}
		});
		...
		btnStartTime.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new TimePickerDialog(SearchSDCardVideoActivity.this, startTimeOnTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), false).show();
			}
		});
		...
		btnStopDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new DatePickerDialog(SearchSDCardVideoActivity.this, stopDateOnDateSetListener, cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DAY_OF_MONTH)).show();
			}
		});
		...
		btnStopTime.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new TimePickerDialog(SearchSDCardVideoActivity.this, stopTimeOnTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), false).show();
			}
		});
