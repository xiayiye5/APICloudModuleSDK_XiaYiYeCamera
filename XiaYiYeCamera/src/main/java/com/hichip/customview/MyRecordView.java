...
public class MyRecordView extends View {
	...
	private ValueAnimator playAni;// 圆弧进度变化
	private String centerText;// 中间文字
	private boolean isPlayRecording;// 是否是在播放录音
	private boolean isPlayType;// 是否是在播放录音
	...
	protected void onDraw(final Canvas canvas) {
		...
		// 录制的过程中绘制进度条
		// Log.e("==isRecording==isPlayType",isRecording+"----"+ isPlayType);
